...
const workExperience = [
  {year: 'Apr. 2019 - Jun. 2020', title: 'Full-Stack Developer', name: 'Bees2Biz - Bogotá, Colombia (Remote)', description: 'Front-end development (VueJS), database design (MySQL), API development (Django REST framework).'},
  ...
  {year: 'Jul. 2017 - Jan. 2019', title: 'Full-Stack Developer', name: 'Global Solution Outsourcing Group - Quito, Ecuador (Remote)', description: 'Web development (Python/Django, JavaScript, CSS3/Bootstrap), hosting configuration and database management (PostgreSQL).'},
